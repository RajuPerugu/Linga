...
$GuestPassword = Read-Host -Prompt 'What is your root password?' -AsSecureString

Invoke-VMScript -VM $VM -ScriptText "echo 1 > /sys/bus/scsi/devices/0\:0\:1\:0/rescan;parted /dev/sdb resizepart 1 100%;pvresize /dev/sdb1;lvextend -l +100%FREE /home;xfs_growfs /home;df -h /home " -GuestUser $GuestUser -GuestPassword $GuestPassword
